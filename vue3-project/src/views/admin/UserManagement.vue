...
const columns = [
  ...
  { key: 'user_id', label: '聚包盆号', type: 'user-link', sortable: false , maxLength: 15},
...
const formFields = [
  { key: 'user_id', label: '聚包盆号', type: 'text', required: true, placeholder: '请输入聚包盆号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '聚包盆号', placeholder: '搜索聚包盆号' },
