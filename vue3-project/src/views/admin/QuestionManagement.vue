<template>
  <CrudTable title="问卷问题管理" entity-name="问卷问题" api-endpoint="/admin/survey-questions" :columns="columns" :form-fields="formFields"
...
const formFields = [
  { key: 'survey_id', label: '问卷ID', type: 'number', required: true, placeholder: '请输入问卷ID' },
  ...
  { key: 'sort_order', label: '排序序号', type: 'number', required: true, placeholder: '请输入排序序号' },
  { key: 'is_required', label: '是否必填', type: 'checkbox', required: false }
]
